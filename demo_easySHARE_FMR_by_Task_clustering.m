...
load(sprintf('cluster_idx_task_data_%s.mat',data_keyword{i_data})); %load idx_task, which collects indices representing the group ID of clustered tasks. 1: Group 1, 2: Group 2, etc.
...
if ~flag_use_pre_tuned_best_k
    ...
    load(sprintf('tuned_best_k_data_%s_task_clustering.mat',data_keyword{i_data}));
...
str = sprintf('result_FMR_task_clustering_data_%s.mat',data_keyword{i_data});
