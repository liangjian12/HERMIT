...
disp('##############################')
save(sprintf('result_nMSE_aAUC_MOE_task_clustering_data_%s_method_%s.mat',data_keyword{i_data},method_name{j_method})); 

toc
 
end

str = sprintf('result_MOE_task_clustering_data_%s.mat',data_keyword{i_data});
