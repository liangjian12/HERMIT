function [best_param1,best_param2,score,best_score] = choose_param_on_valid_MTL_2param(train_X,train_Y,valid_X,valid_Y,train_Omega,valid_Omega_c,valid_Omega_b,...
