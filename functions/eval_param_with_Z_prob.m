function [PR_W,RC_W,FP_W,AUC_W,l2_norm_W,PR_Z,RC_Z,FP_Z,AUC_Z ] = eval_param_with_Z_prob(W,W_true,d_total,Z_idx_out,Z_idx)
...
[~,~,~,AUC_Z] = perfcurve(double(z_idx),double(z_idx_out),1);
