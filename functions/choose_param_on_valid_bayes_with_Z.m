function [opts_save,x,y,record_y_out,record_x_out] = choose_param_on_valid_bayes_with_Z(train_X,train_Y,train_Omega,valid_X,valid_Y,valid_Y_outlier,valid_Z_idx,valid_Omega,...
