function [best_param,score] = choose_param_on_valid_randmiss_complete_logfun(train_X,train_Y,valid_X,valid_Y,observe_rate_train,observe_rate_c,...
...
%         score_tmp = scorer(valid_X,valid_Y,W,Phi,pi,[],valid_Omega_c,opts);
