function [best_param_1,best_param_2,score] = choose_param_on_valid_MTL_rand_cmpl_with_Z_2param_mar(train_X,train_Y,valid_X,valid_Y,observe_rate_train,observe_rate_c,observe_rate_b,...
