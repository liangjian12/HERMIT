function [W,Z,Phi] = apg_W_GD_with_Z_multi_comp(X,Y,opts)
% Input:
...
[x] = apg(@grad_W_GD_with_Z_multi_comp, @soft_thresh_W_GD_with_Z_multi_comp, dim_x, opts); % x is a vector, containing all the parameters    
