function [fun_c,mean_sparse_rate,share,mean_spec_rate,nmse,auc,aupr,nmse_poiss,rho] = scorer_without_Z_real_int_complete(X,Y,W,Phi,pi,pi_each,Omega_c,Omega_b,opts,method)
