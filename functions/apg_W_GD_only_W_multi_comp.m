function [W] = apg_W_GD_only_W_multi_comp(X,Y,opts)
% Input:
...
[x] = apg(@grad_W_GD_only_W_multi_comp, @soft_thresh_W_GD_only_W_multi_comp_sep, dim_x, opts); % x is a vector, containing all the parameters    
