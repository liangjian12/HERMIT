function [fun_c,nmi_val,PR_W,RC_W,FP_W,AUC_W,l2_norm_W,PR_Z,RC_Z,FP_Z,AUC_Z,l2_norm_Z] = scorer_with_Z_all_train_prob(X,Y,Y_outlier,Z_idx,W,Z,Phi,pi,Omega,opts)
