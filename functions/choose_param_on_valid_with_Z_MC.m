function [best_param,score,best_score] = choose_param_on_valid_with_Z_MC(valid_X,valid_Y,valid_Omega_c,valid_Omega_b,...
...
parfor i = 1:n
    ...
    opts.lambda = param;
    for iter = 1:iter_num
        [W,Z,Phi,pi] = solver(valid_X,valid_Y,valid_Omega_c.*valid_Omega_b,k,opts,prox_param);        
