function v = soft_thresh_W_GD_only_W_multi_comp_sep(x, t, opts)
...
if opts.sep_pen_inside.W.flag
    for r = 1:k
        for i_type = 1:3
            ...
            W(2:end,idx,r) = sub_prox_fun(W(2:end,idx,r),t,opts.prox_param.W.method,opts.prox_param.W.param(i_type,r),...
                opts.prox_param.W.fix_feature_flag,opts.prox_param.W.fix_feature(2:end,idx,r));
        end
    end
else
    for r = 1:k
