function [opts_save,x,y,record_y_out,record_x_out] = choose_param_on_valid_bayes_with_Z_multi_comp(train_X,train_Y,train_Omega,valid_X,valid_Y,valid_Y_outlier,valid_Z_idx,valid_Omega,...
...
for iter = 1:iter_num_find
    ...
    opts.tau = zeros(1,opts.k);
        ...
        opts.tau(1) = 10^x(cont);cont = cont + 1;
...
opts_save.tau = zeros(1,opts_save.k);
    ...
    opts_save.tau(1) = 10^x(cont);cont = cont + 1;
