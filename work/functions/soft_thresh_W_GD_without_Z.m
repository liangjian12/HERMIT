function v = soft_thresh_W_GD_without_Z(x, t, opts)
...
if isfield(opts.prox_param.W,'ada_lasso_flag')  
    if opts.prox_param.W.ada_lasso_flag 
        W(2:end,:) = sub_prox_fun_with_ada(W(2:end,:),t,opts.prox_param.W.method,opts.prox_param.W.param,...
        opts.prox_param.W.fix_feature_flag,opts.prox_param.W.fix_feature(2:end,:),opts.prox_param.W.ada_lasso_weight_this(2:end,:));
    end
elseif isfield( opts.prox_param.W, 'capL1_flag')
    if opts.prox_param.W.capL1_flag
        W(2:end,:) = sub_prox_fun_with_capL1(W(2:end,:),t,opts.prox_param.W.method,opts.prox_param.W.param,...
        opts.prox_param.W.fix_feature_flag,opts.prox_param.W.fix_feature(2:end,:),opts.prox_param.W.capL1_weight_this(2:end,:));
    end     
else
W(2:end,:) = sub_prox_fun(W(2:end,:),t,opts.prox_param.W.method,opts.prox_param.W.param,...
    opts.prox_param.W.fix_feature_flag,opts.prox_param.W.fix_feature(2:end,:));
