function [opts_save,x,y,record_y_out,record_x_out] = choose_param_on_valid_bayes_AUC(train_X,train_Y,train_Omega,valid_X,valid_Y,valid_Omega,...
    k,opts_save,prox_param,lb,ub,solver,scorer,iter_out_num,iter_num_find,iter_num_rep)
