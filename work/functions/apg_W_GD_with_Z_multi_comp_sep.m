function [W,Z,Phi] = apg_W_GD_with_Z_multi_comp_sep(X,Y,opts)
% Input:
...
%     opts_tmp.Phi = opts.Phi(idx,idx);
    ...
    opts_tmp.prox_param.Z.ada_lasso_weight = opts.prox_param.W.ada_lasso_weight(:,idx,:);
...
%     [x,opts_tmp] = apg_plus(@grad_W_GD_with_Z_multi_comp, @soft_thresh_W_GD_with_Z_multi_comp, @opti_close_Phi_with_Z_multi_comp, dim_x, opts_tmp); % x is a vector, containing all the parameters   
    [x,opts_tmp] = apg(@grad_W_GD_with_Z_multi_comp, @soft_thresh_W_GD_with_Z_multi_comp_sep, dim_x, opts_tmp); % x is a vector, containing all the parameters   
