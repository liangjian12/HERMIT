function [W,Phi,pi,pi_each] = solver_SEP_without_Z(X,Y,Omega,k,opts,prox_param)
...
%     opts_tmp.lambda = lambda_set(i_type);
%     opts_tmp.prox_param.W.ada_lasso_weight = zeros(d,sum(idx));
    ...
    [W_j,Phi_j,pi_j] = solver_sub_without_Z(X,Y(:,idx),k,opts_tmp,prox_param);
