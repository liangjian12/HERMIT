function [W] = apg_W_GD_only_W_multi_comp_sep(X,Y,opts)
% Input:
...
%     [x,opts_tmp] = apg_plus(@grad_W_GD_with_Z_multi_comp, @soft_thresh_W_GD_with_Z_multi_comp, @opti_close_Phi_with_Z_multi_comp, dim_x, opts_tmp); % x is a vector, containing all the parameters   
    [x] = apg(@grad_W_GD_only_W_multi_comp, @soft_thresh_W_GD_only_W_multi_comp_sep, dim_x, opts_tmp); % x is a vector, containing all the parameters   
