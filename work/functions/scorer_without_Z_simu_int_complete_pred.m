function [fun_c,mean_sparse_rate,share,mean_spec_rate,nmse,auc,nmse_poiss,...
    PR_W,RC_W,FP_W,AUC_W] = scorer_without_Z_simu_int_complete_pred(X,Y,W,Phi,pi,pi_each,Omega_c,Omega_b,opts,method)
...
if opts.k > 1
    ...
    [nmse,auc,aupr,nmse_poiss] = estimate_fun_without_Z_kn_pred_nmse_auc(X,Y,W,Phi,rho,pi,Omega_p,opts);
