function [best_param,score] = choose_param_on_valid_randmiss_complete_with_Z_fix_lambda(train_X,train_Y,valid_X,valid_Y,observe_rate_train,observe_rate_c,observe_rate_b,...
