function [best_param,score] = choose_param_on_valid_randmiss_complete(train_X,train_Y,valid_X,valid_Y,observe_rate_train,observe_rate_c,observe_rate_b,...
...
%         score(iter,i) = scorer(valid_X,valid_Y,W,Phi,pi,valid_Omega_c,opts);
        ...
        score(iter,i) = sum(score_tmp);%score_tmp(2);
